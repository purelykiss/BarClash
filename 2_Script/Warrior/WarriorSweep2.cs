...
public partial class WarriorSweep2 : Node, IState
{
    [Export] WarriorMove _warriorMove;
    [Export] string _id = "sweep2";
    ...
    public void Animation()
    {
        ...
        {
            flagAnimate = true;
            _baseMove.SetAnimation("sweep2", false);
        }
    }
    ...
    public void OnFinish()
    {
        ...
        _warriorMove.AtkList.DisableAttackBox("sweep2");
    }
}
