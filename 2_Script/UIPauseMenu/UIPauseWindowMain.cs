...
public partial class UIPauseWindowMain : ColorRect, IWindow
{
    [Export] string _id = "main";
    UIPauseMenu _UIPauseMenu;
    bool _isActive;
    [Export] Button _GoMainButton;
    [Export] Button _RestartButton;
	...
	public override void _Ready()
	{
        ...
        if (!_RestartButton.IsConnected(Button.SignalName.Pressed, new Callable(this, MethodName.RestartButtonPressed)))
            _RestartButton.Connect(Button.SignalName.Pressed, new Callable(this, MethodName.RestartButtonPressed));
    ...
    {
        _UIPauseMenu.ActivatePopup("restart");
    }
