...
public partial class WarriorSlash3 : Node, IState
{
    [Export] WarriorMove _warriorMove;
    [Export] string _id = "slash3";
    ...
    public bool Condition()
    {
        ...
        {
            if (_warriorMove.FSM.CurrentState.ID == "slash2")
                return true;
        }
    ...
    public void Animation()
    {
        ...
        {
            flagAnimate = true;
            _baseMove.SetAnimation("slash3", false);
        }
    }
    ...
    public void Move()
    {
        if (_isTryingActivateAttack)
        {
            if (!flagActivateAttack)
            {
                ...
                _warriorMove.SndList.ActivateSound("slash3");
            }
        }
        else
        {
    ...
    public void OnFinish()
    {
        ...
        _warriorMove.AtkList.DisableAttackBox("slash3");
    }
}
