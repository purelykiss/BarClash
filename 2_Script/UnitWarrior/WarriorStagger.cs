...
public partial class WarriorStagger : Node, IState, IStagger
{
    ...
    public bool Condition()
    {
        ...
        {
            if (_warriorMove.HitList[0].Stagger == 1 || _warriorMove.HitList[0].Stagger == 2)
            {
