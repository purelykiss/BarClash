...
public partial class WarriorBeam3 : Node, IState
{
    [Export] WarriorMove _warriorMove;
    [Export] string _id = "beam3";
    ...
    public bool Condition()
    {
        ...
        {
            if (_fsm.CurrentState.ID == "beam2" || _fsm.CurrentState.ID == "beam1")
            {
                return true;
            }
        }
    ...
    public void Animation()
    {
        ...
        {
            flagAnimate = true;
            _baseMove.SetAnimation("beam3", false);
        }
    }
