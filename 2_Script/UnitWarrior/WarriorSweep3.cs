...
public partial class WarriorSweep3 : Node, IState
{
    [Export] WarriorMove _warriorMove;
    [Export] string _id = "sweep3";
    ...
    public void Animation()
    {
        ...
        {
            flagAnimate = true;
            _baseMove.SetAnimation("sweep3", false);
        }
    }
    ...
    public void Move()
    {
        ...
        if (flagFirstCycle)
        {
            ...
            if (_warriorMove.TargetUnit.GlobalPosition.X < _baseMove.GlobalPosition.X)
            {
                ...
                _warriorMove.CurVelocity += Vector2.Left * _warriorMove.CurWalkSpeed;
            }
            else
            {
                _warriorMove.CurDirection = DirectionH.RIGHT;
                _warriorMove.CurVelocity += Vector2.Right * _warriorMove.CurWalkSpeed;
            }
        }
        else
        {
    ...
    public void OnFinish()
    {
        ...
        _warriorMove.AtkList.DisableAttackBox("sweep3");
    }
}
