...
public partial class WarriorSlash1 : Node, IState, IEnemyPattern
{
    [Export] WarriorMove _warriorMove;
    [Export] string _id = "slash1";
    ...
    public bool Condition()
    {
        ...
        if (_baseMove.IsGrounded)
        {
            if (_warriorMove.IsTryingAttack)
            {
                ...
                {
                    if (Mathf.Abs(_warriorMove.TargetUnit.GlobalPosition.X - _warriorMove.GlobalPosition.X) < 115)
                        return true;
                }
            }
        }
    ...
    public void Animation()
    {
        ...
        {
            flagAnimate = true;
            _baseMove.SetAnimation("slash1", false);
        }
    }
    ...
    public void Move()
    {
        ...
        if (flagFirstCycle)
        {
            ...
            _warriorMove.EfctList.ActivateEffect("eyeHighlight");
            _warriorMove.SndList.ActivateSound("flashing");
            _warriorMove.SndList.ActivateSound("wind");
        }
        else
        {
    ...
    public void OnFinish()
    {
        ...
        _warriorMove.EfctList.DisableEffect("eyeHighlight");
    }
}
