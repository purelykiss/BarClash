...
public partial class WarriorBeam2 : Node, IState
{
    [Export] WarriorMove _warriorMove;
    [Export] string _id = "beam2";
    ...
    public bool Condition()
    {
        ...
        {
            if (_fsm.CurrentState.ID == "beam1" && _warriorMove.CurPhase > 1)
            {
                return true;
            }
        }
    ...
    public void Animation()
    {
        ...
        {
            flagAnimate = true;
            _baseMove.SetAnimation("beam2", false);
        }
    }
