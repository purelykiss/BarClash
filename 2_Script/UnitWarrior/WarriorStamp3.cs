...
public partial class WarriorStamp3 : Node, IState
{
    [Export] WarriorMove _warriorMove;
    [Export] string _id = "stamp3";
    ...
    public bool Condition()
    {
        ...
        {
            if (_warriorMove.FSM.CurrentState.ID == "stamp2")
            {
                if (Mathf.Abs(_warriorMove.TargetUnit.GlobalPosition.X - _baseMove.GlobalPosition.X) < 70)
                    return true;
            }
        }
    ...
    public void Animation()
    {
        ...
        {
            flagAnimate = true;
            _baseMove.SetAnimation("stamp3", false);
        }
    }
    ...
    public void Move()
    {
        if (_isTryingActivateAttack)
        {
            if (!flagActivateAttack)
            {
                ...
                _baseMove.SndList.ActivateSound("swordHeavy");
            }
        }
        else
        {
    ...
    public void OnFinish()
    {
        ...
        _warriorMove.AtkList.DisableAttackBox("stamp3");
    }
}
