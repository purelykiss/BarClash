...
public partial class WarriorSweep4 : Node, IState
{
    [Export] WarriorMove _warriorMove;
    [Export] string _id = "sweep4";
    ...
    public bool Condition()
    {
        ...
        {
            if (_warriorMove.IsTryingSweepCombo && _warriorMove.CurPhase > 1)
                return true;
        }
    ...
    public void Animation()
    {
        ...
        {
            flagAnimate = true;
            _baseMove.SetAnimation("sweep4", false);
        }
    }
    ...
    public void OnFinish()
    {
        ...
        _warriorMove.AtkList.DisableAttackBox("sweep4");
    }
}
