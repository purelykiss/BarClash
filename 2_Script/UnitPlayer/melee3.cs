...
public partial class melee3 : Node, IState
{
    [Export] PlayerMove _playerMove;
    [Export] string _id = "melee3";
    ...
    public void Animation()
    {
        ...
        {
            flagAnimate = true;
            _baseMove.SetAnimation("melee3", false);
        }
    }
    ...
    public void Move()
    {
        ...
        if (_playerMove.IsDead
            || _curDuration <= 0
            || (_curDuration <= 0.4f && (Input.IsActionPressed("player_left") || Input.IsActionPressed("player_right")))
            || !_playerMove.IsGrounded)
            _curCancelState = IState.Cancelable.Always;
        else if (_curDuration <= 0.5f)
    ...
    public void OnFinish()
    {
        ...
        _playerMove.AtkList.DisableAttackBox("melee3");
    }
}
