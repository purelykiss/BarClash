...
public partial class dodge : Node, IState
{
    ...
    public void Move()
    {
        ...
        if(flagActivateDodge)
        {
            ...
            _baseMove.SndList.ActivateSound("dodge");
            if (flagDownDodge)
            {
                _baseMove.EfctList.ActivateEffect("afterimageWhite");
                _baseMove.EfctList.ActivateEffect("oneAfterimage");
                _baseMove.EfctList.ActivateEffect("trail");
            }
            _baseMove.EfctList.ActivateEffect("afterimage");
    ...
    public void OnFinish()
    {
        ...
        _curDuration = 0;
        _baseMove.EfctList.DisableEffect("trail");
        _baseMove.EfctList.DisableEffect("oneAfterimage");
        _baseMove.EfctList.DisableEffect("afterimageWhite");
        _baseMove.EfctList.DisableEffect("afterimage");
    }
}
