...
public partial class dashJumpMelee2 : Node, IState
{
    [Export] PlayerMove _playerMove;
    [Export] string _id = "dashJumpMelee2";
    ...
    public bool Condition()
    {
        ...
        if (!_baseMove.IsGrounded)
        {
            ...
            {
                if(_playerMove.FSM.CurrentState.ID == "dashJumpMelee1")
                    return true;
            }
        }
    ...
    public void Animation()
    {
        ...
        {
            flagAnimate = true;
            _baseMove.SetAnimation("dashJumpMelee2", false);
        }
    }
    ...
    public void Move()
    {
        ...
        if (flagFirstCycle)
        {
            ...
            _baseMove.CurVelocity = Vector2.Up * _playerMove.JumpSpeed * 0.6f;
    ...
    public void OnFinish()
    {
        ...
        _playerMove.AtkList.DisableAttackBox("dashJumpMelee2");
    }
}
